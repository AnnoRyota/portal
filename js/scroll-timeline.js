!function() {
    ...
    function n(n, t, i) {
        return t && e(n.prototype, t), i && e(n, i), Object.defineProperty(n, "prototype", {
            writable: !1
        }), n
    }
    function t() {
    ...
    !function() {
        ...
        function r(e) {
            for (var n, t = [], i = 0; i < e.length; i++)
                t[i] = "number" == typeof (n = e[i]) ? new CSSUnitValue(n, "number") : n;
            return t
        }
        var a = function() {
                function e(e, n, i, a) {
        ...
        for (var l in window.CSSUnitValue || ["number", "percent", "em", "ex", "px", "cm", "mm", "in", "pt", "pc", "Q", "vw", "vh", "vmin", "vmax", "rems", "ch", "deg", "rad", "grad", "turn", "ms", "s", "Hz", "kHz", "dppx", "dpi", "dpcm", "fr"].forEach(function(e) {
            ...
            if (!(l in window) && !Reflect.defineProperty(window, l, {
                value: o[l]
            }))
    ...
    function f(e, n) {
        ...
        var t = "horizontal-tb" == getComputedStyle(e).writingMode,
            i = e.scrollTop;
        return ("x" == n || "inline" == n && t || "block" == n && !t) && (i = Math.abs(e.scrollLeft)), i
    }
    function h(e) {
        if (e instanceof P) {
            var n = e.subject;
    ...
    function d(e, n) {
        var t = u.get(e),
            i = t.source,
            r = t.scrollListener;
        if (i != n && (i && r && c(i).removeEventListener("scroll", r), u.get(e).source = n, n)) {
            var a = function() {
                m(e)
            };
            c(n).addEventListener("scroll", a),
            t.scrollListener = a
        }
    }
    function p(e, n) {
    ...
    var g = function() {
        function e(n) {
            if (u.set(this, {
                ...
                subject: null,
                inset: n ? n.inset : null,
                animations: [],
                scrollListener: null
            }), d(this, n && void 0 !== n.source ? n.source : document.scrollingElement), n && void 0 !== n.axis && n.axis != s) {
                if (!e.isValidAxis(n.axis))
                    throw TypeError("Invalid axis");
                u.get(this).axis = n.axis
            }
            m(this)
        }
        return e.isValidAxis = function(e) {
            ...
            get: function() {
                ...
                return "none" == n.display ? "inactive" : e == document.scrollingElement || "visible" != n.overflow && "clip" != n.overflow ? "active" : "inactive"
            }
        }, {
            key: "currentTime",
            get: function() {
                ...
                if ("inline" === t.display || "none" === t.display)
                    return e;
                var i = this.axis,
                    r = f(n, i),
                    a = function(e, n) {
                        var t = "horizontal-tb" == getComputedStyle(e).writingMode;
                        return "block" === n ? n = t ? "y" : "x" : "inline" === n && (n = t ? "x" : "y"), "y" === n ? e.scrollHeight - e.clientHeight : "x" === n ? e.scrollWidth - e.clientWidth : void 0
                    }(n, i);
    ...
    function b(e) {
        var n = getComputedStyle(e);
        return "none" != n.transform || "none" != n.perspective || "transform" == n.willChange || "perspective" == n.willChange || "none" != n.filter || "filter" == n.willChange || "none" != n.backdropFilter
    }
    function w(e) {
    ...
    function x(e, n) {
        var t = u.get(e);
        return "inactive" === e.phase ? null : e instanceof P ? I(n, e.source, e.subject, t.axis, t.inset) : null
    }
    function I(e, n, t, i, r) {
        for (var a = 0, o = 0, l = t, s = n.offsetParent; l && l != s;)
            ...
            a += l.offsetTop,
            l = l.offsetParent;
        o -= n.offsetLeft + n.clientLeft,
        a -= n.offsetTop + n.clientTop;
        var u = getComputedStyle(n),
            c = "horizontal-tb" == u.writingMode,
            m = void 0,
            f = void 0,
            h = void 0;
        "x" == i || "inline" == i && c || "block" == i && !c ? (m = t.clientWidth, f = o, ("rtl" == u.direction || "vertical-rl" == u.writingMode) && (f += n.scrollWidth - n.clientWidth), h = n.clientWidth) : (m = t.clientHeight, f = a, h = n.clientHeight);
        var d = function(e, n) {
                var t = {
                    start: 0,
                    end: 0
                ...
                return 1 == r.length ? (t.start = r[0], t.end = r[0]) : 2 == r.length && (t.start = r[0], t.end = r[1]), t
            }(r, h),
            p = f - h + d.end,
            v = f + m - d.start,
            g = p + m,
    ...
    function N(e, n, t) {
        return e && t ? (n.value / 100 * (e.end - e.start) + e.start - t.start) / (t.end - t.start) : 0
    }
    var P = function(e) {
            function t(n) {
                var t;
                return t = e.call(this, n) || this, u.get(a(t)).subject = n && n.subject ? n.subject : void 0, h(a(t)), m(a(t)), t
            }
            return i(t, e), n(t, [{
                key: "source",
                get: function() {
                ...
                get: function() {
                    ...
                    if (n == e)
                        return e;
                    var t = x(this, "cover");
                    return t ? CSS.percent((n - t.start) / (t.end - t.start) * 100) : e
                }
            }]), t
        }(g),
        A = window.Element.prototype.animate,
        C = window.Animation,
        R = ["entry", "exit", "cover", "contain", "entry-crossing", "exit-crossing"],
        O = function() {
            function e() {
                var e = this;
                this.state = "pending",
    ...
    function j(e, n) {
        if (null === n)
            return n;
        if ("number" != typeof n)
            throw new DOMException("Unexpected value: " + n + ".  Cannot convert to CssNumberish", "InvalidStateError");
        var t = q(e);
    ...
    function V(e) {
        if (e.finishedPromise && "pending" == e.finishedPromise.state && "finished" == e.proxy.playState) {
            e.finishedPromise.resolve(e.proxy),
            e.animation.pause();
    ...
    function z(e, n, t) {
        if (e.timeline) {
            ...
            if (i && null != e.startTime && !e.proxy.pending) {
                ...
                r > 0 && i >= a && null != e.previousCurrentTime ? ((null === o || o < a) && (o = a), e.holdTime = n ? i : o) : r < 0 && i <= 0 ? ((null == o || o > 0) && (o = 0), e.holdTime = n ? i : o) : 0 != r && (n && null !== e.holdTime && (e.startTime = F(e, e.holdTime)), e.holdTime = null)
            }
            K(e),
            e.previousCurrentTime = W(e, e.proxy.currentTime),
            "finished" == e.proxy.playState ? (e.finishedPromise || (e.finishedPromise = new O), "pending" == e.finishedPromise.state && (t ? V(e) : Promise.resolve().then(function() {
                V(e)
            }))) : (e.finishedPromise && "resolved" == e.finishedPromise.state && (e.finishedPromise = new O), "paused" != e.animation.playState && e.animation.pause())
        }
    }
    function q(e) {
        var n = function(e) {
    ...
    function K(e) {
        if (e.timeline)
            if (null !== e.startTime) {
                ...
                null !== e.holdTime && G(e, e.holdTime)
    }
    function G(e, n) {
        var t = e.timeline,
            i = e.animation.playbackRate;
        e.animation.currentTime = n + (t.currentTime && t.currentTime.value == (i < 0 ? 0 : 100) ? i < 0 ? .001 : -.001 : 0)
    }
    function Q(e, n) {
        if (e.timeline) {
            ...
            var o = D(e),
                l = q(e);
            if (o > 0 && n && (null == a || a < 0 || a >= l))
                r = 0;
            else if (o < 0 && n && (null == a || a <= 0 || a > l)) {
                if (Infinity == l)
                    return void e.animation.play();
                r = l
            } else
                0 == o && null == a && (r = 0);
            ...
            (null !== e.holdTime || null !== r || t || null !== e.pendingPlaybackRate) && (e.readyPromise && !i && (e.readyPromise = null), K(e), e.readyPromise || L(e), e.pendingTask = "play", z(e, !1, !1))
        }
    }
    function X(e) {
        var n = B.get(this);
        if (null != e) {
            ...
            "running" != t && "finished" != t || (G(n, (W(n, e) - W(n, this.startTime)) * this.playbackRate), "finished" == t && 0 != D(n) && (n.holdTime = null), z(n, !1, !1))
        } else
            "idle" != n.animation.playState && n.animation.cancel()
    }
    function Y(e) {
        "pause" == e.pendingTask ? function(e) {
            var n = W(e, e.timeline.currentTime);
            null != e.startTime && null == e.holdTime && (e.holdTime = (n - e.startTime) * e.animation.playbackRate),
            U(e),
            e.startTime = null,
            ...
            if (null != e.holdTime)
                U(e),
                0 == e.animation.playbackRate ? e.startTime = n : (e.startTime = n - e.holdTime / e.animation.playbackRate, e.holdTime = null);
            else if (null !== e.startTime && null !== e.pendingPlaybackRate) {
                var t = (n - e.startTime) * e.animation.playbackRate;
                U(e);
                var i = e.animation.playbackRate;
                0 == i ? (e.holdTime = null, e.startTime = n) : e.startTime = n - t / i
            }
    ...
    var B = new WeakMap,
        $ = function() {
            function e(e, n, t) {
                void 0 === t && (t = {});
                var i = e instanceof C ? e : new C(e, a),
                    r = n instanceof g,
                    a = r ? void 0 : n;
                B.set(this, {
                    animation: i,
                    ...
                    effect: null,
                    animationRange: n instanceof ViewTimeline ? ne(t["animation-range"]) : null,
                    proxy: this
                })
            }
            var t = e.prototype;
            return t.finish = function() {
                ...
                if (e.timeline) {
                    ...
                    "pause" == e.pendingTask && null !== e.startTime && (e.holdTime = null, e.pendingTask = null, e.readyPromise.resolve(this)),
                    "play" == e.pendingTask && null !== e.startTime && (e.pendingTask = null, e.readyPromise.resolve(this)),
                    z(e, !0, !0)
                } else
                    e.animation.finish()
            }, t.play = function() {
                ...
                if (n.pendingPlaybackRate = e, n.timeline) {
                    if (!n.readyPromise || "pending" != n.readyPromise.state)
                        ...
                        case "finished":
                            var t = W(n, n.timeline.currentTime),
                                i = null !== t ? (t - n.startTime) * n.animation.playbackRate : null;
                            n.startTime = 0 == e ? t : null != t && null != i ? (t - i) / e : null,
                            U(n),
                            z(n, !1, !1),
                            K(n);
                            break;
                    ...
                    n.animation.updatePlaybackRate(e)
            }, t.persist = function() {
                B.get(this).animation.persist()
            }, t.cancel = function() {
                var e = B.get(this);
                e.timeline ? ("idle" != this.playState && (function(e) {
                    e.pendingTask && (e.pendingTask = null, U(e), e.readyPromise.reject(_()), L(e), e.readyPromise.resolve(e.proxy))
                }(e), e.finishedPromise && "pending" == e.finishedPromise.state && e.finishedPromise.reject(_()), e.finishedPromise = new O, e.animation.cancel()), e.startTime = null, e.holdTime = null, p(e.timeline, e.animation)) : e.animation.cancel()
                ...
                get: function() {
                    ...
                    return e.timeline ? (e.effect || (e.effect = function(e) {
                            ...
                            r = {
                                apply: function(i, r) {
                                    ...
                                    return e.timeline instanceof ViewTimeline && (o = function(e) {
                                        ...
                                        return 1 - M(e.timeline, n.rangeName, n.offset)
                                    }(e), c = !0), (null === u.duration || "auto" === u.duration || c) && e.timeline && (c ? (u.delay = o * a, u.endDelay = l * a) : (u.delay = 0, u.endDelay = 0), s = u.iterations ? a : 0, u.duration = u.iterations ? (s - u.delay - u.endDelay) / u.iterations : 0, u.duration < 0 && (u.duration = 0, u.endDelay = s - u.delay), t.apply(n, [u])), e.normalizedTiming = u, e.specifiedTiming
                                }
                            },
                            a = {
                                apply: function(t, i, r) {
                                    ...
                                    e.specifiedTiming && t.apply(n, [e.specifiedTiming]),
                                    t.apply(n, r),
                        ...
                        return o.getComputedTiming = new Proxy(n.getComputedTiming, i), o.getTiming = new Proxy(n.getTiming, r), o.updateTiming = new Proxy(n.updateTiming, a), o
                ...
                set: function(e) {
                    ...
                    if (n != e) {
                        ...
                        if (l && p(r.timeline, r.animation), s) {
                            ...
                            return u && (r.readyPromise && "resolved" != r.readyPromise.state || L(r), r.pendingTask = "paused" == t ? "pause" : "play"), null !== r.startTime && (r.holdTime = null), void z(r, !1, !1)
                        }
                        if (r.animation.timeline != e)
                            throw TypeError("Unsupported timeline: " + e);
                        if (p(r.timeline, r.animation), r.timeline = null, l)
                            switch (null !== i && (r.animation.currentTime = o * q(r)), t) {
                            case "paused":
                                r.animation.pause();
                                break;
                            case "running":
                ...
                set: function(e) {
                    ...
                    if (e = W(n, e), n.timeline) {
                        null == W(n, n.timeline.currentTime) && null != n.startTime && (n.holdTime = null, K(n));
                        var t = W(n, this.currentTime);
                        U(n),
                        n.startTime = e,
                        n.resetCurrentTimeOnResume = !1,
                        n.holdTime = null !== n.startTime && 0 != n.animation.playbackRate ? null : t,
                        n.pendingTask && (n.pendingTask = null, n.readyPromise.resolve(this)),
                        z(n, !0, !1),
                        K(n)
                    } else
                        n.animation.startTime = e
                }
            }, {
                key: "currentTime",
                get: function() {
                    var e = B.get(this);
                    return e.timeline ? j(e, null != e.holdTime ? e.holdTime : H(e)) : e.animation.currentTime
                },
                set: function(e) {
                    var n = B.get(this);
                    if (e = W(n, e), n.timeline && null != e) {
                        var t = n.timeline.phase;
                        null !== n.holdTime || null === n.startTime || "inactive" == t || 0 == n.animation.playbackRate ? n.holdTime = e : n.startTime = F(n, e),
                        n.resetCurrentTimeOnResume = !1,
                        "inactive" == t && (n.startTime = null),
                        n.previousCurrentTime = null,
                        "pause" == n.pendingTask && (n.holdTime = e, U(n), n.startTime = null, n.pendingTask = null, n.readyPromise.resolve(this)),
                        z(n, !0, !1)
                    } else
                ...
                get: function() {
                    ...
                    if (null != n) {
                        if (e.animation.playbackRate > 0 && n >= q(e))
                            return "finished";
                        if (e.animation.playbackRate < 0 && n <= 0)
                            return "finished"
                    }
                    return "running"
                }
                ...
                get: function() {
                    var e = B.get(this);
                    return e.timeline ? (e.finishedPromise || (e.finishedPromise = new O), e.finishedPromise.promise) : e.animation.finished
                }
            }, {
                key: "ready",
                get: function() {
                    var e = B.get(this);
                    return e.timeline ? (e.readyPromise || (e.readyPromise = new O, e.readyPromise.resolve(this)), e.readyPromise.promise) : e.animation.ready
                }
            }]), e
        }();
    function J(e, n) {
        ...
        if (!(i instanceof Object)) {
            ...
            var a = parseFloat(i);
            i.endsWith("%") ? i = CSS.percent(a) : i.endsWith("px") && (i = CSS.px(a))
        }
        return {
            rangeName: t,
            offset: i
    ...
    function ne(e) {
        ...
        return i.length && (n.start.rangeName = i[0], n.end.rangeName = i.length > 1 ? i[1] : i[0]), r.length > 1 && (n.start.offset = CSS.percent(r[0]), n.end.offset = CSS.percent(r[1])), n
    }
    function te(e, n) {
        var t = n.timeline;
        t instanceof g && delete n.timeline;
        var i = A.apply(this, [e, n]),
            r = new $(i, t);
        return t instanceof g && (i.pause(), t instanceof ViewTimeline && (B.get(r).animationRange = {
    ...
    var ie = {
        ...
        oe = new (function() {
            ...
            var n = e.prototype;
            return n.transpileStyleSheet = function(e, n, t) {
                for (var i = {
                    sheetSrc: e,
                    index: 0,
                    name: t
                    ...
                    if (this.lookAhead("/*", i))
                        ...
                        r && (n ? this.parseKeyframesAndSaveNameMapping(r, i) : this.handleScrollTimelineProps(r, i))
                    }
                return i.sheetSrc
                ...
                for (var t = this.cssRulesWithTimelineName.length - 1; t >= 0; t--) {
                    ...
                    try {
                        if (n.matches(i.selector) && (!i["animation-name"] || i["animation-name"] == e))
                            return {
                ...
                for (var r = this.sourceSelectorToScrollTimeline.length - 1; r >= 0; r--) {
                    ...
                    if (a.name == e) {
                        var o = this.findPreviousSiblingOrAncestorMatchingSelector(n, a.selector);
                        if (o)
                            return t({
                                source: o
                            }, a.axis ? {
                ...
                if (t)
                    return t;
                for (var i = this.subjectSelectorToViewTimeline.length - 1; i >= 0; i--) {
                    var r = this.subjectSelectorToViewTimeline[i];
                    if (r.name == e) {
                        var a = this.findPreviousSiblingOrAncestorMatchingSelector(n, r.selector);
                        if (a)
                            return {
                                subject: a,
                                axis: r.axis,
                ...
                if (!e.selector.includes("@keyframes")) {
                    ...
                    if (this.saveSourceSelectorToScrollTimeline(e), this.saveSubjectSelectorToViewTimeline(e), r || i || a) {
                        var o = [],
                            l = [],
                            s = !1;
                        r && (o = this.extractScrollTimelineNames(e.block.contents)),
                        i && (l = this.extractMatches(e.block.contents, ie.ANIMATION_NAME)),
                        r && i || (a && this.extractMatches(e.block.contents, ie.ANIMATION).forEach(function(n) {
                            var i = t.extractAnimationName(n);
                            i && r && l.push(i),
                            r && (t.hasDuration(n) || (t.hasAutoDuration(n) && (e.block.contents = e.block.contents.replace("auto", "    ")), e.block.contents = e.block.contents.replace(n, " 1s " + n), s = !0))
                        }), s && this.replacePart(e.block.startIndex, e.block.endIndex, e.block.contents, n)),
                ...
                if (t || i) {
                    var a = [];
                    if (t)
                        for (var o, s = l(this.extractMatches(e.block.contents, ie.SCROLL_TIMELINE)); !(o = s()).done;) {
                            var u = this.split(o.value),
                                c = {
                                    selector: e.selector,
                                    name: ""
                                };
                            1 == u.length ? c.name = u[0] : 2 == u.length && (re.includes(u[0]) ? (c.axis = u[0], c.name = u[1]) : (c.axis = u[1], c.name = u[0])),
                            a.push(c)
                        }
                    if (i)
                        for (var m = this.extractMatches(e.block.contents, ie.SCROLL_TIMELINE_NAME), f = 0; f < m.length; f++)
                            f < a.length ? a[f].name = m[f] : a.push({
                                selector: e.selector,
                                name: m[f]
                            });
                    var h = [];
                    if (r) {
                        var d = this.extractMatches(e.block.contents, ie.SCROLL_TIMELINE_AXIS);
                        if ((h = d.filter(function(e) {
                ...
                if (t || i) {
                    var o = [];
                    if (t)
                        for (var s, u = l(this.extractMatches(e.block.contents, ie.VIEW_TIMELINE)); !(s = u()).done;) {
                            ...
                            1 == c.length ? m.name = c[0] : 2 == c.length && (re.includes(c[0]) ? (m.axis = c[0], m.name = c[1]) : (m.axis = c[1], m.name = c[0])),
                            o.push(m)
                        }
                    if (i)
                        for (var f = this.extractMatches(e.block.contents, ie.VIEW_TIMELINE_NAME), h = 0; h < f.length; h++)
                            h < o.length ? o[h].name = f[h] : o.push({
                                selector: e.selector,
                                name: f[h],
                                inset: null
                            });
                    var d = [],
                        p = [];
                    if (a && (d = this.extractMatches(e.block.contents, ie.VIEW_TIMELINE_INSET)), r) {
                        var v = this.extractMatches(e.block.contents, ie.VIEW_TIMELINE_AXIS);
                        if ((p = v.filter(function(e) {
                            return re.includes(e)
                        })).length != v.length)
                            throw new Error("Invalid axis")
                    }
                ...
                var r = [];
                e.block.contents.includes("animation-range:") && (r = this.extractMatches(e.block.contents, ie.ANIMATION_TIME_RANGE));
                for (var a = Math.max(n.length, i.length, r.length), o = 0; o < a; o++)
                    this.cssRulesWithTimelineName.push(t({
                        selector: e.selector,
                        "animation-timeline": n[o % n.length]
                    }, i.length ? {
                        "animation-name": i[o % i.length]
                    } : {}, r.length ? {
                ...
                return e.startsWith("scroll(") ? this.anonymousScrollTimelineOptions.set(n, this.parseAnonymousScrollTimeline(e)) : this.anonymousViewTimelineOptions.set(n, this.parseAnonymousViewTimeline(e)), n
            }, n.parseAnonymousScrollTimeline = function(e) {
                var n = ie.ANONYMOUS_SCROLL_TIMELINE.exec(e);
                if (!n)
                    return null;
                var t = {};
                return n[1].split(" ").forEach(function(e) {
                ...
                var t = {};
                return n[1].split(" ").forEach(function(e) {
                    re.includes(e) ? t.axis = e : t.inset = t.inset ? t.inset + " " + e : e
                }), t
                ...
                if (!n)
                    throw this.parseError(e, "Expected an identifier");
                ...
                for (var l = function(e) {
                        ...
                        o.push(l.join(",")),
                        o.push(e == i.length - 1 ? t.substring(i[e].end) : t.substring(i[e].end, i[e + 1].start))
                    }, s = 0; s < i.length; s++)
                    l(s);
                return a ? (e.block.contents = o.join(""), this.replacePart(e.block.startIndex, e.block.endIndex, e.block.contents, n), r) : new Map
                ...
                this.assertString(e, "{");
                for (var t = 1; 0 != t;)
                    this.lookAhead("/*", e) ? this.eatComment(e) : ("{" === e.sheetSrc[e.index] ? t++ : "}" === e.sheetSrc[e.index] && t--, this.advance(e));
                var i = e.index;
                return {
                    startIndex: n,
                    endIndex: i,
                ...
                return Error("(" + (e.name ? e.name : "<anonymous file>") + "): " + n)
            }, n.eatUntil = function(e, n, t) {
                void 0 === t && (t = !1);
                for (var i = n.index; !this.lookAhead(e, n);)
                    this.advance(n);
                return t && (n.sheetSrc = n.sheetSrc.slice(0, i) + " ".repeat(n.index - i) + n.sheetSrc.slice(n.index)), n.sheetSrc.slice(i, n.index)
                ...
                return void 0 === t && (t = ","), n.exec(e)[1].trim().split(t).map(function(e) {
                    return e.trim()
                })
            }, n.split = function(e) {
    ...
    !function() {
        if (!function() {
            ...
            window.addEventListener("animationstart", function(n) {
                n.target.getAnimations().filter(function(e) {
                    ...
                    if (!i.has(t.animationName)) {
                        var r = function(e, n, t) {
                            ...
                            if (!r)
                                return null;
                            var a = oe.getScrollTimelineOptions(r, t) || oe.getViewTimelineOptions(r, t);
                            return a ? (a.subject && function(e, n) {
                                var t = E(n.subject),
                                    i = n.axis || n.axis,
                                ...
                                if (r && r.size) {
                                            ...
                                            for (var a, o = null, s = l(e); !(a = s()).done;) {
                                                ...
                                                if (u[0] == 100 * r.offset) {
                                                    if ("from" == c)
                                                        ...
                                                        var m = c.split(" ");
                                                        o = 1 == m.length ? parseFloat(m[0]) : 100 * le(m[0], t, n.subject, i, n.inset, CSS.percent(parseFloat(m[1])))
                                                    }
                                                    break
                                                }
                                            }
                                    ...
                                    var o = a.sort(function(e, n) {
                                        return e.offset < n.offset ? -1 : e.affset > n.offset ? 1 : 0
                                    });
                        ...
                        i.set(t.animationName, r && r.timeline && t.timeline != r.timeline ? new $(t, r.timeline, r.animOptions) : null)
                    }
            ...
            if ([].concat(document.styleSheets).filter(function(e) {
                return null !== e.href
            }).length && console.warn("Non-Inline StyleSheets detected: ScrollTimeline polyfill currently only supports inline styles within style tags"), !Reflect.defineProperty(window, "ScrollTimeline", {
                value: g
            }))
